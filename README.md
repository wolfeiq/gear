...
Output: Pattern matched to users with catastrophizing→mind_reading cascade. 
- Recommended: Behavioral experiments (82% effectiveness, 0.5 avg improvement).
...
To start it up, use graph_3d_viewer.html with the graphs_with_distortions.json file.
